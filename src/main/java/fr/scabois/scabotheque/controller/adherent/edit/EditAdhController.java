...
//    private static final Logger logger = LoggerFactory.getLogger(FileUploadController.class);
    ...
    public EditAdherent adhToEdit(Adherent adh) {
        ...
        editableAdh.setDateCreation(adh.getDateCreation());
        ...
        editableAdh.setLinkedin(adh.getLinkedin());
        editableAdh.setLongitude(adh.getLongitude());
        editableAdh.setMail(adh.getMail());
        editableAdh.setNbSalaries(adh.getNbSalaries());
        ...
        editableAdh.setTelephone(adh.getTelephone());
