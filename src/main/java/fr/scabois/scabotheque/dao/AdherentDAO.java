...
//    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public Long countContacts() {
        TypedQuery<Long> query = entityManager.createQuery("select count(*) from AdherentContactRole", Long.class);
        return query.getSingleResult();
    }
...
//    entityManager.getTransaction().commit();
    ...
    private Adherent updateAdherentData(Adherent bddAdherent, Adherent adherent) {
        ...
        bddAdherent.setDateCreation(adherent.getDateCreation());
        ...
        bddAdherent.setNbSalaries(adherent.getNbSalaries());
