...
<h1><spring:message code="label.identite"/> add ...</h1>

<form:form class="editAdherent bg-red-500" method="post" modelAttribute="adhToAdd" action="addAdherent">
  <form:input type="hidden" class="grid grid-cols-2" path="adherent.id"/>
  ...
  <fieldset class="grid grid-cols-4">
    ...
    <div class="showDetailAdherent">
      <form:label path="adherent.commune"><spring:message code="label.commune"/></form:label>
        <div>
        <form:label class="valeur" id="communeAdhLibelle"
                    path="adherent.commune">${adhToAdd.adherent.commune.codePostal} - ${adhToEdit.adherent.commune.libelle}</form:label>
  ...
  <fieldset>
    ...
    <div class="showDetailAdherent">
      <form:label path="adherent.rcsCommune"><spring:message code="label.rcsCommune"/></form:label>
        <div>
        <form:label class="valeur" id="rcsCommuneLibelle"
                    path="adherent.rcsCommune">${adhToAdd.adherent.rcsCommune.codePostal} - ${adhToEdit.adherent.rcsCommune.libelle}</form:label>
