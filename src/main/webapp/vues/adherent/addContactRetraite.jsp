...
<form:form class="content" method="post" modelAttribute="addContactForm" action="addContactRetraite">
  <div class="flex flex-col gap-10 mx-16">
    <div>
      <span class="text-xs">Adhérent de référence</span>
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-6 px-10">
        ...
        <div class="grid grid-cols-2 gap-6">
          <div>
            <form:label class="text-xs" path="editContactRetraite.mail"><spring:message code="label.mail"/></form:label>
            <form:input class="block py-2.5 px-0 w-full text-sm text-black dark:text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        ...
        <div class="grid grid-cols-3 gap-6">
          ...
          <div>
            <form:label class="text-xs" path="editContactRetraite.commune"><spring:message code="label.commune"/>
    ...
    <div class="flex justify-center mt-10 gap-2">
      <c:url value="/listeRetraites" var="url"/>
