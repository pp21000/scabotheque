            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="logistique">
                  <div class="card-body pt-0">
                    <dl class="row">
                      ...
                      <dd class="col-sm-8"><spring:message code="message.commune" arguments="${infoExploitation.commune.codePostal}, ${infoExploitation.commune.libelle}"/></span>
                      <dt class="col-sm-4"><spring:message code="label.contactLogistique"/></dt>
                      <dd class="col-sm-8">${infoExploitation.contact1.getLibelle}</dd>
                      <dt class="col-sm-4"></dt>
                      <dd class="col-sm-8">${infoExploitation.contact1.getMobile}</dd>
                      <dt class="col-sm-4"></dt>
                      <dd class="col-sm-8">${infoExploitation.contact2.getLibelle}</dd>
                      <dt class="col-sm-4"></dt>
                      <dd class="col-sm-8">${infoExploitation.contact2.getMobile}</dd>
                      ...
                      <dt class="col-sm-4"><spring:message code="label.protocolDechargement"/></dt>
                      <dd class="col-sm-8">${infoExploitation.dechargementProtocol}</dd>
                    </dl>
                  </div>
                  <!-- /.card-body -->
                </div>
              ...
              <sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_CRM')">
                <div class="tab-pane" id="CRM">
                  <div class="card-body pt-0">
                    <form:form class="form-inline ml-3" method="post" modelAttribute="criteria" action="adherentCRM?idAdh=${adherent.id}">
                      <input type="hidden" value="${adherent.id}" name="adhId">
                      <spring:message code="label.texteRecherche" var="recherchePH"/>
                        
                      <div class="input-group input-group-sm">
                        <form:input style="form-control " type="text" path="text" placeholder="${recherchePH}" autofocus="true"/>
                        <div class="input-group-append"> 
                          <button id="actionButton" class="btn btn-info btn-flat" type="submit">
