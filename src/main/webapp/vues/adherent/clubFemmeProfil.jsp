                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <div class="w-full">
                        <div class="grid grid-cols-5">
                            <div class="col-span-2 flex justify-end font-semibold"><spring:message
                                    code="label.adhArtipole"/></div>
                            <div class="flex justify-center">
                        ...
                        <div class="grid grid-cols-5">
                            <div class="col-span-2 font-semibold flex justify-end"><spring:message
                                    code="label.pole"/></div>
                            <div class="flex justify-center">
                                <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                                     xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="grid grid-cols-5">
                            <div class="col-span-2 font-semibold flex justify-end"><spring:message
                                    code="label.agenceRattachement"/></div>
                            <div class="flex justify-center">
                                <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
...
<!--                <div class="bg-neutral-50 rounded border border-neutral-100 p-4">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">
                            <spring:message
                                    code="label.agenceRattachement"/> :
                            ${adherent.agence.libelle}</label>
                    </div>
                    <label class="col-sm-3 col-form-label"><spring:message
                            code="label.secteur"/> :
                        ${adherent.secteur.libelle}</label>
