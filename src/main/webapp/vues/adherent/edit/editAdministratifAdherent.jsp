...
<form:form class="editAdherent" method="post" modelAttribute="adhToEdit" action="editAdministratifAdh">
  ...
  <div class="flex justify-center">
    <form:label path="editAdherent.commune"><spring:message code="label.commune"/> :</form:label>
      ...
      <form:label id="communeAdhLibelle"
                  path="editAdherent.commune">${adhToAdd.editAdherent.commune.codePostal} - ${adhToEdit.editAdherent.commune.libelle}</form:label>
      <form:input id="communeAdh" type="hidden" path="editAdherent.commune.id"/>
    ...
    <form:errors class="error" path="editAdherent.commune"/>
  </div>

  <fieldset class="flex flex-col gap-2 justify-center items-center">
    ...
    <div class="grid grid-cols-2 gap-2 w-full w-1/2">
      <div class="showDetail">
        <form:label path="editAdherent.dateEntree"><spring:message code="label.dateEntree"/></form:label>
          <span>
          <form:input
            class="block p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-neutral-500 focus:border-neutral-500"
            type="date" name="editAdherent.dateEntree" path="editAdherent.dateEntree"/>
          <form:errors class="errors" path="editAdherent.dateEntree"/>
        </span>
      </div>
      ...
      <div class="showDetail">
        ...
        <form:select
          class="flex justify-center py-2 px-4 w-72 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
          name="editAdherent.role" path="editAdherent.role.id">
          <form:options items="${roleList}" itemValue="id" itemLabel="libelle"/>
        </form:select>
        <b><i><form:errors path="editAdherent.role"/></i></b>
      </div>
      ...
      <div class="showDetail">
        ...
        <b><i><form:errors path="editAdherent.siren"/></i></b>
      </div>
      ...
      <div class="showDetail">
        ...
        <b><i><form:errors path="editAdherent.siret"/></i></b>
      </div>
      ...
      <div class="showDetail">
        ...
        <form:input class="flex justify-center py-2 px-4 w-72 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
                    name="editAdherent.numRepMetier" path="editAdherent.numRepMetier"/>
        <b><i><form:errors path="editAdherent.numRepMetier"/></i></b>
      </div>

      <div class="showDetail"> 
        <form:label path="editAdherent.rcsRm" ><spring:message code="label.rcsRm"/></form:label> 
        <form:select class="flex justify-center py-2 px-4 w-72 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <b><i><form:errors path="editAdherent.rcsRm" /></i></b> 
      </div> 
        ...
        <form:label code="label.rcsCommune" path="editAdherent.rcsCommune" >
          ...
          <div class="flex">
            ...
            <input type="text" id="communeRCSLibelle" disabled
                   class="rounded-none text-sm rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300"
                   placeholder="${adhToEdit.editAdherent.rcsCommune.codePostal} - ${adhToEdit.editAdherent.rcsCommune.libelle}">
          </div>
          <form:errors class="text-red-600 animate-pulse" path="editAdherent.rcsCommune"/>
        </form:label>
      </div>
      ...
      <div class="relative z-0 mb-6 w-full group">
        ...
        <form:label code="label.rmCommune" path="editAdherent.rmCommune" >
          ...
          <div class="flex">
            <div class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 rounded-l-md border border-r-0 border-gray-300   ">
              <a type="button" data-modal-toggle="rmcommune-modal" class="input-group-text"
            ...
            <input type="text" id="communeRMLibelle" disabled
                   class="rounded-none text-sm rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300"
                   placeholder="${adhToEdit.editAdherent.rmCommune.codePostal} - ${adhToEdit.editAdherent.rmCommune.libelle}">
          </div>
          <form:errors class="text-red-600 animate-pulse" path="editAdherent.rmCommune"/>
        </form:label>
      </div>
      ...
      <div class="grid grid-cols-2 gap-2">
        <form:label path="editAdherent.dateClotureExe"><spring:message code="label.dateClotureExe"/></form:label>
          ...
          <form:errors class="errors" path="editAdherent.dateClotureExe"/>
        </span>
      </div>
      ...
      <%--<form:select--%>
        <!--class="flex py-2 px-4 w-72 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"-->
      ...
      <div class="grid grid-cols-2 gap-2">
        <form:label path="editAdherent.dateSortie"><spring:message code="label.dateSortie"/> :</form:label>
          ...
          <form:errors class="errors" path="editAdherent.dateSortie"/>
        </span>
      </div>
      ...
      <div class="grid grid-cols-2 gap-2">
        <form:label path="editAdherent.formationDirigeant"><spring:message
            code="label.formationCommerce"/> :</form:label>
        <form:input
          class="block p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-neutral-500 focus:border-neutral-500"
  ...
  <fieldset class="flex justify-center mt-4">
    ...
    <form:textarea
      class="w-96 h-16 block text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
