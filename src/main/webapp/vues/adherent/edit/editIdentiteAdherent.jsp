...
<form:form class="" method="post" modelAttribute="adhToEdit" action="editIdentiteAdh?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
  <fieldset class="flex justify-center">
    <div>
      <legend class="text-center mt-4 mb-2 underline"><spring:message code="label.agence"/></legend>
        ...
        <div class="rounded bg-neutral-50 p-4 border border-neutral-200 flex flex-col items-center">
          <div class="text-sm font-semibold">
            ...
            <c:choose>
              ...
              <c:otherwise>
                <img class="max-w-[14rem] mx-auto" src="${adhToEdit.editAdherent.logo}" alt="Photo de l'entreprise">
              </c:otherwise>
            </c:choose>
          <form:input path="editAdherent.fileLogo" class=" my-2 text-xs " type="file" name="file" accept="image/x-png,image/gif,image/jpeg"/> <br/>
            ...
            <c:choose>
              ...
              <c:otherwise>
                <img class="max-w-[14rem] mx-auto" src="${adhToEdit.editAdherent.photo}" alt="Logo de l'entreprise"/>
              </c:otherwise>
            </c:choose>
          ...
          <button class="px-3 py-2 text-xs font-medium text-center text-white bg-neutral-700 rounded-lg hover:bg-neutral-800 focus:ring-4 focus:outline-none focus:ring-neutral-300" type="submit"/>
          enregistrer l'image
        </button >
      </div>
    </div>
      ...
      <div>
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.codeERP"><spring:message code="label.codeERP"/></form:label>
            </div>
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.codeERPParent"><spring:message code="label.codeERPParent"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.libelle"><spring:message code="label.libelle"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.denomination"><spring:message code="label.denomination"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.telephone"><spring:message code="label.telephone"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.mail"><spring:message code="label.mail"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.adresse"><spring:message code="label.adresse"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.adresseComplement"><spring:message code="label.adresseComplement"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.pole.id"><spring:message code="label.pole"/></form:label>
            </div>
          <form:select
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.latitude"><spring:message code="label.latitude"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
        ...
        <div class="flex items-center mt-2">
          <div class="flex-grow w-56 mx-2">
            <form:label class="flex items-center mt-2 text-left" path="editAdherent.longitude"><spring:message code="label.longitude"/></form:label>
            </div>
          <form:input class="flex-grow py-2 px-4 w-96 text-sm text-gray-900 bg-gray-50 border rounded border-gray-300 focus:ring-neutral-500 focus:border-neutral-500"
