...
<div class="text-2xl mb-4">
  <spring:message code="label.contactsRetraite"/>
</div>
      ...
      <ul class="inline-flex items-center -space-x-px">
        <c:if test="${maxPage > 0}">
          ...
          <c:forEach var="i" begin="${page == 1 ? 1 : page-1}" end="${page == maxPage ? maxPage : page+1 }">
            <li>
              <a href="listeContacts?page=${i}" class="<c:if test="${page == i}"> text-neutral-600 bg-neut href="listeContacts?page=${i}"ral-50 border-neutral-300 </c:if> py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700">
                ${i}
              </a>
            </li>
          </c:forEach>
