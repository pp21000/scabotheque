        ...
        <table class="w-10/12 text-sm text-left text-gray-500">
            ...
            <tr>
                ...
                <th scope="col" class="text-center py-4">
                    <div>Saisie de la semaine ${chiffresSemaine.numSemaine}</div>
                ...
                <th scope="col" class="text-center">
                    <div>Saisie à partir du 01/<fmt:formatDate pattern="MM" value="${chiffresSemaine.dateFin}" /></div>
                ...
                <th scope="col" class="rounded-r-lg text-center">
                    <div>Saisie à partir du 01 janvier</div>
                    <div class="grid grid-cols-4 mt-2">
                        <div>N</div>
                        <div>N-1</div>
                        <div>N-2</div>
            ...
            <c:forEach items="${chiffresSemaine.chiffresActivite}" var="chiffre" varStatus="status">
                <tr class="bg-white">
                    <th scope="row">${chiffre.activite.libelle}</th>
                    <td class="py-2 px-2">
                        <c:choose>
