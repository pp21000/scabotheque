...
<button class="btn btn-green btn-small" id="addBtn" type="button" onclick="showNewForm()">Ajouter un Métier</button>
  ...
  <form:form class="w-11/12 mt-5" method="post" modelAttribute="editForm" action="AA-edit-metiers">    
    <c:forEach items="${editForm.metiers}" var="edit" varStatus="status">
      ...
      <div class="flex items-center gap-2 mb-6">
          ...
          <div class="flex-1">
            <form:textarea class="flex-grow w-full input-textarea h-20" name="editMetiers[${status.index}].description" path="editMetiers[${status.index}].description" id="description"/>
