...
<html>
  ...
  <body class="hold-transition login-page" style="background-image: url(resources/dist/img/Background-Scabois.png); background-size: cover;">
    ...
    <div class="flex h-screen">
      ...
      <section class="m-auto bg-gray-50 dark:bg-gray-900 px-16 py-16">
        <div class="flex flex-col items-center justify-center">
          ...
          <div class="w-full bg-gray rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 class="text-xl my-4 font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium
                            rounded-lg text-sm py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Se connecter</button>
