                ...
                <li>
                  <a href="<c:url value="/addAdherent"/>"
                       class="<c:if test = "${pageType == '' || pageType == 'CREATE_ADHERENT'}"> text-green-500 </c:if> flex items-center p-2 text-base font-normal text-gray-900 dark:text-gray-50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                        ...
                        <div class="ml-1 whitespace-nowrap text-sm"><spring:message code="label.addAdherent"/></div>
                    </a>
                </li>
            </sec:authorize>
                    ...
                    <form:form class="h-6" id="exportListForm" method="post" modelAttribute="criteria" action="exportList">
                        ...
                        <a href="javascript:;" onclick="parentNode.submit();"
                           class="<c:if test = "${pageType == '' || pageType == 'CREATE_ADHERENT'}"> text-green-500 </c:if> flex items-center p-2 text-base font-normal text-gray-900 dark:text-gray-50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 ">
                            ...
                            <div class="ml-1 whitespace-nowrap text-sm"><spring:message code="menu.exportExcel"/></div>
                        </a>
                    </form:form>
                </li>
            </sec:authorize>
                    ...
                    <form:form class="h-6" id="exportListForm" method="post" modelAttribute="criteria" action="exportListAll">
                        ...
                        <a href="javascript:;" onclick="parentNode.submit();"
                           class="<c:if test = "${pageType == '' || pageType == 'CREATE_ADHERENT'}"> text-green-500 </c:if> flex items-center p-2 text-base font-normal text-gray-900 dark:text-gray-50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <div class="ml-1 whitespace-nowrap text-sm"><spring:message code="label.exportW&B"/></div>
                        </a>
                    </form:form>
                </li>
            </sec:authorize>
                    ...
                    <form:form id="exportListForm" method="post" modelAttribute="criteria" action="exportListAll">
                        ...
                        <a href="javascript:;" onclick="parentNode.submit();"
                           class="<c:if test = "${pageType == '' || pageType == 'CREATE_ADHERENT'}"> text-green-500 </c:if> flex items-center p-2 text-base font-normal text-gray-900 dark:text-gray-50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <div class="ml-1 whitespace-nowrap text-sm"><spring:message code="label.exportAll"/></div>
                        </a>
                    </form:form>
                </li>
            </sec:authorize>
