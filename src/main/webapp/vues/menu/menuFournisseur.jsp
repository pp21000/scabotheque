        ...
        <ul class="space-y-2">
            ...
            <li>
              <a href="<c:url value="/listeFournisseur"/>"
                   class="<c:if test = "${pageType == 'LIST_FOURNISSEUR'}"> text-green-500 font-bold </c:if> flex items-center p-2 text-base font-normal text-gray-50 rounded-lg hover:bg-gray-100">
                    <svg aria-hidden="true"
                         class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                         fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
                    </svg>
                    <span class="flex-1 ml-3 whitespace-nowrap">Liste Fournisseurs</span>
                </a>
            </li>
        </ul>
    </div>
